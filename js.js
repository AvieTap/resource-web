...
$(document).ready(function(){
    ...
    // Quick fix until I actually make an intuitive method of getting people to understand pressing enter for input boxes
    ...
    $("#toggleReal").click(function(){
        if (realOFF == false) {
            ...
            if ($("#font-body").val() != "") {
                $("body").css("font-family", $("#font-body").val());
            } else {
            ...
            $("body").css("background-color", "var(--bg)");
            $("body, h1, h2, h3, h4, p").css("font-family", "monospace");
            $(".miniText").css("font-family", $("#font-body").val());
            $("h1").css("color", "white");
            if ($("#col-h1").val() != "") {
                $("#h1").css("color", $("#col-h1").val());
            } else {
